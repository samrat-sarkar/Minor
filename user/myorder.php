...
<?php
include 'config.php';
$sql = "SELECT * FROM issue_book WHERE UserID='$UserID'"; 
...
$sta = $result['Status'];
 if ($sta=="Taken") {
    ...
    $sta1 = "";
          ...
          '<tbody>'.
          "<tr>".
          "<th>ORDER ID :</th><td>" . $result['OrderID']. "</td>". 
          "</tr>".
          "<tr>".
          "<th>CONFIRMATION CODE :</th><td>" . $result['CNFCode']. "</td>". 
          "</tr>".
