...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #007bff;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <span class="badge badge-pill badge-danger"><?php echo "[ Hey ".$UserID; ?> ]</span><span class="sr-only">(current)</span></div>
      <a class="nav-item nav-link text-cyan font-weight-bold" href="home.php">Book Search</a>
      <a class="nav-item nav-link text-cyan font-weight-bold" href="admin/addbooks.php">Add Book</a>
      <a class="nav-item nav-link text-cyan font-weight-bold" href="admin/view.php">View Book</a>
      <a class="nav-item nav-link text-cyan font-weight-bold" href="admin/order.php">Order</a>
      <a class="nav-item nav-link text-cyan font-weight-bold" href="admin/issue.php">Issue Book</a>
      <a class="nav-item nav-link text-cyan font-weight-bold" href="admin/userlist.php">User List</a>
